 ...
 *
 * Core controls and sanitization pairs.
 ...
 *                         'radionica_sanitize_nohtml',
 *                         'radionica_sanitize_image',
 *                         'radionica_sanitize_html',
 *                         'radionica_sanitize_hex_color',
 *                         'radionica_sanitize_css'
 ...
 *     'radio'          => 'radionica_sanitize_choices'
 *     'select'         => 'radionica_sanitize_choices'
 *     'number'         => 'radionica_sanitize_number_range',
 *                         'radionica_sanitize_number_absint'
 *     'checkbox'       => 'radionica_sanitize_checkbox'
 *     'dropdown-pages' => 'radionica_sanitize_dropdown_pages'
 *     'password'       => 'radionica_sanitize_nohtml'
 *     'hidden'         =>
 *     'date'           =>
 *
 * Advanced controls
 * @link https://developer.wordpress.org/reference/classes/wp_customize_manager/wp_loaded/
 *
 *     'WP_Customize_Image_Control' => 'radionica_sanitize_image'
 *     'WP_Customize_Color_Control' => 'radionica_sanitize_hex_color',
 *                                     'sanitize_hex_color',
 *                                     'sanitize_hex_color_no_hash'
 ...
 */
function radionica_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function radionica_sanitize_choices( $input, $setting ) {
 ...
 */
function radionica_sanitize_css( $css ) {
 ...
 */
function radionica_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function radionica_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function radionica_sanitize_html( $html ) {
 ...
 */
function radionica_sanitize_nohtml( $nohtml ) {
 ...
 */
function radionica_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function radionica_sanitize_number_range( $number, $setting ) {
 ...
 */
function radionica_sanitize_image( $image, $setting ) {
	/*
